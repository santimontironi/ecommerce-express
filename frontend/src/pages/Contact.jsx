    ...
    <div className="w-full min-h-screen bg-white flex justify-center items-center py-16 containerContact border-t border-[#ececec]">
      {messageLoading ? <Loader /> : (
        <div className="w-[90%] max-w-[700px] bg-[#2a2a2a] text-white rounded-2xl shadow-2xl p-10 border border-[#101010]">
          ...
          <form className="flex flex-col gap-6" onSubmit={handleSubmit(onSubmit)}>
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`p-3 rounded-lg bg-[#3b3b3b] text-white border ${errors.name ? 'border-red-500' : 'border-gray-600'
            ...
            <div className="flex flex-col">
              ...
              <input
                ...
                className={`p-3 rounded-lg bg-[#3b3b3b] text-white border ${errors.email ? 'border-red-500' : 'border-gray-600'
                  } focus:outline-none focus:border-blue-500`}
                {...register("email", {
            ...
            <div className="flex flex-col">
              ...
              <textarea
                ...
                className={`p-3 rounded-lg bg-[#3b3b3b] text-white border ${errors.message ? 'border-red-500' : 'border-gray-600'
          ...
          {messageSent && (
            <p className="text-green-600 font-bold text-center mt-4">{messageSent}</p>
          )}
