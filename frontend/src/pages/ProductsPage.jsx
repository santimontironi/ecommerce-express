    ...
    <div className="min-h-screen w-full pb-10 containerProductsPage">
      ...
      {loading ? <Loader /> : (
        allProducts.length === 0 ? <h1>No hay productos</h1> : (
          <div className="flex flex-col items-center justify-center md:grid md:grid-cols-2 xl:grid-cols-3 xl:w-[1000px] md:place-content-center gap-5 md:gap-10 xl:gap-15 mx-auto mt-10">
